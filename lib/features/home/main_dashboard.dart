...
class _MainDashboardState extends State<MainDashboard> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: () async {
          return await Globals.database.query("SELECT * FROM dailylogs WHERE accountid=${Globals.currentAccount['accounts']!['accountid']} AND date=TO_DATE('${DateFormat('yyyy-MM-dd').format(DateTime.now())}', 'YYYY-MM-DD')");
        }(),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        SizedBox(width: 340, height: 340, child: DashboardWidgets.dashboardCard(logData['weight'].toDouble(), Globals.goalMap['weight'].toDouble(), 'Weight')),
                        SizedBox(width: 340, height: 340, child: DashboardWidgets.dashboardCard(logData['calorieintake'].toDouble(), Globals.goalMap['calorieintake'].toDouble(), 'Calories')),
                        SizedBox(width: 340, height: 340, child: DashboardWidgets.dashboardCard(logData['steps'].toDouble(), Globals.goalMap['steps'].toDouble(), 'Steps')),
                      ],
                    ),
                    Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        SizedBox(width: 340, height: 340, child: DashboardWidgets.dashboardCard(logData['hydration'].toDouble(), Globals.goalMap['hydration'].toDouble(), 'Hydration')),
                        SizedBox(width: 340, height: 340, child: DashboardWidgets.dashboardCard(logData['activemins'].toDouble(), Globals.goalMap['activemins'].toDouble(), 'Active Minutes')),
                        SizedBox(width: 340, height: 340, child: DashboardWidgets.dashboardCard(logData['sleephours'].toDouble(), Globals.goalMap['sleephours'].toDouble(), 'Sleep Duration')),
                      ],
                    )
                  ],
                ),
